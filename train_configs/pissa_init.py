...
def quantize_pissa(
    ...
    lora_config = LoraConfig(
        ...
        if pissa_iter == -1 else f'pissa_niter_{pissa_iter}',
    )
    ...
    # Save PiSSA model
    setattr(peft_model.peft_config['default'], 'base_model_name_or_path',
            os.path.abspath(output_dir))
    setattr(peft_model.peft_config['default'], 'init_lora_weights',
            True)  # don't apply pissa again
